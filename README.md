...
<sub>Also merged in kthena: a repo-wide <a href="https://github.com/volcano-sh/kthena/pull/1244">Go 1.26 upgrade</a>, five more router fixes (<a href="https://github.com/volcano-sh/kthena/pull/1649">dropping a per-block intersection map</a> and <a href="https://github.com/volcano-sh/kthena/pull/1628">sizing the prefix-cache hash up front</a> in the kvcache scorer, <a href="https://github.com/volcano-sh/kthena/pull/1603">a ModelServer trafficPolicy timeout that was never honoured</a>, and <a href="https://github.com/volcano-sh/kthena/pull/1562">score debug logging that ran even with V(4) off</a>), plus a build fix for repo paths containing spaces. Elsewhere: a <a href="https://github.com/kubernetes-sigs/headlamp/pull/6066">rules-of-hooks fix in kubernetes-sigs/headlamp</a> that removed four eslint suppressions hiding it, and <a href="https://github.com/openfoodfacts/openfoodfacts-explorer/pulls?q=is%3Apr+author%3Anabrahma+is%3Amerged">8 a11y and responsive fixes</a> in Open Food Facts. See <a href="https://github.com/pulls?q=is%3Apr+author%3Anabrahma+is%3Amerged">all merged PRs</a>.</sub>
